...
abrir_DRE<-function(df_itr,df_dfp){
   ...
   df_itr_reduzido=df_itr_reduzido%>%select(dte_data=DT_FIM_EXERC,str_conta=CD_CONTA,str_descricao=DS_CONTA,vl_valor=VL_CONTA)%>%arrange(dte_data)
